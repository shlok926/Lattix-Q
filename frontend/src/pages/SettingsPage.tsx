...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12 relative">
      {/* Toast Alert */}
      {showToast && (
        <div className="fixed bottom-6 right-6 z-50 bg-[#22C55E]/10 border border-green-500/30 text-green-400 text-xs px-4 py-3 rounded-lg shadow-2xl flex items-center gap-2 animate-fadeIn">
